...
print """Admin Page Finder
   SSSSSSSSSSSSSSS MMMMMMMM               MMMMMMMM       444444444          CCCCCCCCCCCCC
 SS:::::::::::::::SM:::::::M             M:::::::M      4::::::::4       CCC::::::::::::C
S:::::SSSSSS::::::SM::::::::M           M::::::::M     4:::::::::4     CC:::::::::::::::C
S:::::S     SSSSSSSM:::::::::M         M:::::::::M    4::::44::::4    C:::::CCCCCCCC::::C
S:::::S            M::::::::::M       M::::::::::M   4::::4 4::::4   C:::::C       CCCCCC
S:::::S            M:::::::::::M     M:::::::::::M  4::::4  4::::4  C:::::C              
 S::::SSSS         M:::::::M::::M   M::::M:::::::M 4::::4   4::::4  C:::::C              
  SS::::::SSSSS    M::::::M M::::M M::::M M::::::M4::::444444::::444C:::::C              
    SSS::::::::SS  M::::::M  M::::M::::M  M::::::M4::::::::::::::::4C:::::C              
       SSSSSS::::S M::::::M   M:::::::M   M::::::M4444444444:::::444C:::::C              
            S:::::SM::::::M    M:::::M    M::::::M          4::::4  C:::::C              
            S:::::SM::::::M     MMMMM     M::::::M          4::::4   C:::::C       CCCCCC
SSSSSSS     S:::::SM::::::M               M::::::M          4::::4    C:::::CCCCCCCC::::C
S::::::SSSSSS:::::SM::::::M               M::::::M        44::::::44   CC:::::::::::::::C
S:::::::::::::::SS M::::::M               M::::::M        4::::::::4     CCC::::::::::::C
 SSSSSSSSSSSSSSS   MMMMMMMM               MMMMMMMM        4444444444        CCCCCCCCCCCCC
Admin Page Finder |                   """
...
try:
    ...
    conn.connect()
    print "[+] Web Sitesi Aktif"
except:
    print "[-] Bir Hata Var Gibi?"
    exit()
...
\t(2) ASP
"""
select = input("Seciminiz: ")
if select == 1:
    for admin in php:
        admin = admin.replace("\n","")
        victim = site+"/"+admin
        admin = "/"+admin
        print "\tTaraniyor --> {}".format(victim)
        ...
        if response.status == 200:
            ...
            acp += 1
            raw_input("Devam etmek icin bir tusa basiniz... ")
        elif response.status == 404:
            say = say
        elif response.status == 302:
            print "\t[?] Yonlendirme Sayfasi: {}".format(victim)
        else:
            print "\t[?] Bilinmeyen Sayfa: {}".format(victim)
